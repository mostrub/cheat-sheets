...
AWK (awk) is a domain-specific language designed for text processing and typically used as a data extraction and reporting tool. Similar to the [**Sed**](../../linux/sed/) and [**Grep**](../../linux/grep/) commands, it is a filter, and is a standard feature of most Unix-like operating systems, like [**Linux**](../../linux/linux/).
...
"GAWK: Effective awk Programming," 3d edition, by Arnold D. Robbins (O'Reilly, 2003) or at http://www.gnu.org/software/gawk/manual/
